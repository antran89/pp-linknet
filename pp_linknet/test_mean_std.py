...
parser.add_argument('-t', '--threshold', type=float, default=2.0, help='Threshold to flag it a road or non-road.')
...
mean_iou = 0
gt_files = glob.glob(os.path.join(mask_folder, '*_mask.png'))
...
print('Mean IOU of the prediction model %s with threshold %f on validation set: %f' % (os.path.basename(weight_path), args['threshold'], mean_iou))